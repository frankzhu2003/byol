...
This provides a new perspective to manage log volume effective. You have the option to send "important" log to different destination while keep the rest locally. 
